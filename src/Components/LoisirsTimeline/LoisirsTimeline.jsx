  ...
  useEffect(() => {
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        ...
        gsap.to(img1, {duration: 3, opacity: 1, visibility: "visible", transform: "translateX(200px)" });
      },
      onLeaveBack: () => {
    ...
    ScrollTrigger.create({
      ...
      start: "top 80%",
      onEnter: () => {
        gsap.to(section2, { opacity: 1, visibility: "visible", transform: "translateX(15px)", duration: 3 });
        gsap.to(img2, {duration: 3, opacity: 1, visibility: "visible", transform: "translateX(200px)" });
      },
      onLeaveBack: () => {
        gsap.to(section2, { opacity: 0, visibility: "hidden", transform: "translateY(-30px)", duration: 1 });
        gsap.to(img2, { duration: 3, opacity: 0, visibility: "hidden", transform: "translateY(-60px)" });
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        ...
        gsap.to(img3, {duration: 3, opacity: 1, visibility: "visible", transform: "translateX(200px)" });
      },
      onLeaveBack: () => {
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        ...
        gsap.to(img4, { duration: 3, opacity: 1, visibility: "visible", transform: "translateX(200px)" });
      },
      onLeaveBack: () => {
        gsap.to(section4, { opacity: 0, visibility: "hidden", transform: "translateY(-30px)", duration: 1 });
        gsap.to(img4, { duration: 3, opacity: 0, visibility: "hidden", transform: "translateY(-50px)" });
      },
    });
      ...
      <div className="event">
        ...
        <div className="event-content" ref={section1Ref}>
          <div className="card left-event" id="time_card">
            <h3 id="LoisirsH2">1. LES RANDONNEES</h3>
            <p>
