      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-8 p-4 md:flex-row md:order-2">
        <div className="flex flex-col justify-center max-w-[1000px]">
          ...
          <p className="tracking-wide text-sm md:text-base lg:text-lg pb-4">
            Pour vos moments de détente, nous mettons à votre disposition des chaises longues, des tables, des fauteuils, un billard et un terrain de pétanque gratuitement.
          </p>
          <p className="tracking-wide text-sm md:text-base lg:text-lg pb-4">
            Du mas, vous pourrez partir vous promener sur une route menant à plusieurs points de baignade ou sentiers de randonnée à Chambon. Nous sommes toujours là pour vous indiquer des visites touristiques dans notre région afin que vous passiez de bonnes vacances et découvriez les Cévennes.
          </p>
          <p className="tracking-wide text-sm md:text-base lg:text-lg pb-4">
